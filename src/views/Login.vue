    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <v-facebook-login
          :login-options="{
            scope:
              'ads_management,ads_read,adinstagram_manage_messages,pages_messaging,pages_manage_metadata,instagram_manage_comments,instagram_manage_insights,pages_read_engagement,instagram_basic,pages_show_list,business_management,instagram_content_publish,catalog_management',
          }"
          style="margin: auto"
