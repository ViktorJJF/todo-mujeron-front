        ...
        >
          ...
          <template v-slot:[`item.message`]="{ item }">
            <div v-if="item.message">
              ...
              <div v-if="item.message.payload">
                <pre>{{ JSON.stringify(item.message.payload, null, 2) }}</pre>
              </div>
            </div>
          </template>
...
const ENTITY = "massiveMessagesLogs"; // nombre de la entidad en minusculas (se repite en services y modules del store)
const CLASS_ITEMS = () =>
