                          ...
                          <v-row>
                            <v-col cols="12" sm="12" md="12">
                              <span class="font-weight-bold"
                                >ID Retail Rocket</span
                              >
                              <VTextFieldWithValidation
                                rules="required"
                                v-model="editedItem.idTag"
                                label="Coloca tu ID de etiqueta dado por Retail Rocket"
                              />
                            </v-col>
                          </v-row>
                        </v-container>
...
const ENTITY = "retailRocketTags"; // nombre de la entidad en minusculas (se repite en services y modules del store)
const CLASS_ITEMS = () =>
